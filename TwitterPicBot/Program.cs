...
using TwitterPicBot.Sources;
using TwitterPicBot.Sources.Danbooru;
using TwitterPicBot.Sources.Gelbooru;
using TwitterPicBot.Sources.Konachan;
using TwitterPicBot.Sources.Yandere;
...
namespace TwitterPicBot
{
    class Program
    {
        ...
        public static string Version => pVersion;
        ...
        static void Main(string[] args)
        {
            ...
            pVersion = $@"{asm.Version.Major}.{asm.Version.Minor}.{asm.Version.Build}.{asm.Version.Revision}";

            Log = new Logger($"{appName}.log");
            Log.Write(new LogEntry {
                Section = @"Main",
                Text = $@"Twitter Picture Bot v{Version}",
            });
